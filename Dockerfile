...
RUN pip install matplotlib pandas jupyterlab nbformat nbconvert fiona rtree rasterio pyproj geopandas pysal mapclassify basemap basemap-data basemap-data-hires
